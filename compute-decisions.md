...
|---|---|---|---|
| Compute for Oracle RAC (standard workloads) | Target the environment to match specific workload requirements | [Power Systems Virtual Server](https://cloud.ibm.com/power/overview){: external} — Power10 systems (S1022, E1080) recommended for new deployments | Power10 and Power11 systems provide improved performance, a 3.0:1 virtual-core-to-entitled-capacity ratio in SPPs (versus 1:1 on Power9), and broader data center availability. |
